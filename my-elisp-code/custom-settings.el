(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ibuffer-vc rainbow-mode shm web-beautify hindent sphinx-doc python-docstring yapfify kurecolor which-key jade anzu ox-twbs ace-link dired-ranger flyspell-correct-ivy counsel swiper ivy dired-quick-sort dired-narrow org-pomodoro dired+ free-keys recursive-narrow langtool pyvenv bm page-break-lines mwim manage-minor-mode region-bindings-mode wgrep move-text fold-dwim highlight-indent-guides visual-regexp-steroids hydra aggressive-indent osx-trash avy-zap dired-hacks-utlis reveal-in-osx-finder imenu-anywhere flx company-statistics pytest racket racket-mode volatile-highlights org-journal intero company-anaconda anaconda-mode racer ac-html-bootstrap company-web company-tern cargo rust-mode web-completion-data flycheck-rust f info+ spaceline diff-hl flyspell-mode org-plus-contrib js2-refactor git-timemachine impatient-mode undo-tree google-this zenburn-theme web-mode use-package smex smartparens rainbow-delimiters projectile powerline multiple-cursors markdown-mode magit hungry-delete highlight-symbol haskell-snippets haskell-mode flycheck expand-region exec-path-from-shell emmet-mode company-quickhelp beacon auctex ace-window)))
