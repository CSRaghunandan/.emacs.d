(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (markdown-toc cycle-quotes tide typescript-mode all-the-icons neotree smart-dash num3-mode gitattributes-mode gitconfig-mode gitignore-mode org-download org-cliplink shm skewer-mode quickrun ivy-hydra yaml-mode toml-mode highlight-quoted highlight-numbers column-enforce-mode git-messenger tern js2-mode yasnippet avy company visual-regexp smartparens auto-yasnippet json-snatcher rust-playground realgud inf-mongo psc-ide purescript-mode origami sicp headlong bookmark+ multi-term ace-link osx-trash ox-gfm ws-butler whole-line-or-region ibuffer-vc rainbow-mode web-beautify hindent sphinx-doc python-docstring yapfify kurecolor which-key anzu counsel swiper ivy dired-quick-sort org-pomodoro dired+ free-keys recursive-narrow langtool pyvenv bm page-break-lines mwim manage-minor-mode region-bindings-mode wgrep move-text highlight-indent-guides visual-regexp-steroids hydra avy-zap imenu-anywhere company-statistics pytest racket-mode volatile-highlights org-journal intero company-anaconda anaconda-mode racer ac-html-bootstrap company-web company-tern cargo rust-mode web-completion-data flycheck-rust f info+ spaceline diff-hl js2-refactor git-timemachine impatient-mode undo-tree google-this zenburn-theme web-mode use-package smex rainbow-delimiters projectile powerline multiple-cursors markdown-mode magit hungry-delete highlight-symbol haskell-snippets haskell-mode org-plus-contrib flycheck expand-region exec-path-from-shell emmet-mode beacon auctex ace-window)))
